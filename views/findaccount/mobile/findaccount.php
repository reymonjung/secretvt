...
<div class="wrap">
    ...
    <div class="table-box">
        ...
        <section class="login_find">
            <figure>
                <img src="../assets/images/temp/login_img/login_find.png" alt="find">
                    <?php
                ...
                <figcaption>
                        아이디/비밀번호는 가입시 등록한<br/>
                        메일 주소로 알려드립니다.<br/>
                        가입할 때 등록한 메일 주소를 입력하고 <br/>
                        "아이디/비밀번호 찾기"버튼을 클릭 해주세요.
                </figcaption>
            </figure>

            <?php 
            echo validation_errors('<div class="mail_error" role="alert">', '</div>');
            echo show_alert_message(element('message', $view), '<div class="alert alert-auto-close alert-dismissible alert-info"><button type="button" class="close alertclose" >&times;</button>', '</div>');
            ?>

            <div class="mail_find">
                <input type="email" name="idpw_email" id="idpw_email" class="input_01" placeholder="Email Address" onfocus="this.placeholder=''" onblur="this.placeholder='Email Address'"/>
