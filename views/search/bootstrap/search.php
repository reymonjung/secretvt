    ...
    <form action="<?php echo current_url(); ?>" onSubmit="return checkSearch(this);" class="search_box text-center">
        <div class="col-sm-3">
            <div class="form-group">
                <select class="form-control per100" name="group_id">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <input type="text" class="form-control per100" name="skeyword" placeholder="검색어" value="<?php echo html_escape($this->input->get('skeyword')); ?>" />
            </div>
        </div>
        <div class="col-sm-1">
            <div class="form-group">
        ...
        <div class="col-sm-2">
            <div class="form-group">
                <select class="form-control" name="sop">
