<?php if ($this->member->is_member() === false) { ?>
    ...
    ?>
        ...
        <div class="login mb30">
            ...
            <ol class="loginarea">
                <li><input type="text" class="input" name="mem_userid" placeholder="Enter User ID" value="<?php echo $this->session->flashdata('loginuserid'); ?>" /></li>
                <li><input type="password" class="input" name="mem_password" placeholder="Enter Password" /></li>
            </ol>
...
<?php } else { ?>
    ...
    <div class="welcome mb10">
        ...
        <ul class="mt3per">
            ...
            <li><a href="<?php echo site_url('membermodify'); ?>" class="btn btn-default" title="정보수정">정보수정</a></li>
