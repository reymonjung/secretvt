        ...
        ?>
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" name="new_post_second" id="new_post_second" value="<?php echo set_value('new_post_second', element('new_post_second', element('data', $view)) + 0); ?>" />초 이상 지나야 새로운 글쓰기가 가능합니다
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" name="currentvisitor_minute" id="currentvisitor_minute" value="<?php echo set_value('currentvisitor_minute', element('currentvisitor_minute', element('data', $view)) + 0); ?>" />분 이내의 접속자만 현재 접속자로 인정
                    </div>
                </div>
                <div class="form-group">
