        ...
        ?>
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        패스워드는 최소 <input type="number" class="form-control" name="password_length" id="password_length" value="<?php echo set_value('password_length', element('password_length', element('data', $view)) + 0); ?>" /> 글자 이상이어야 하며,
                        대문자 <input type="number" class="form-control" name="password_uppercase_length" id="password_uppercase_length" value="<?php echo set_value('password_uppercase_length', element('password_uppercase_length', element('data', $view)) + 0); ?>" /> 개를 포함,
                        숫자 <input type="number" class="form-control" name="password_numbers_length" id="password_numbers_length" value="<?php echo set_value('password_numbers_length', element('password_numbers_length', element('data', $view)) + 0); ?>" /> 개를 포함,
                        특수문자 <input type="number" class="form-control" name="password_specialchars_length" id="password_specialchars_length" value="<?php echo set_value('password_specialchars_length', element('password_specialchars_length', element('data', $view)) + 0); ?>" /> 개를 포함하고 있어야 합니다.
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        가로길이 <input type="number" class="form-control" name="member_photo_width" id="member_photo_width" value="<?php echo set_value('member_photo_width', element('member_photo_width', element('data', $view)) + 0); ?>" />px,
                        세로길이 <input type="number" class="form-control" name="member_photo_height" id="member_photo_height" value="<?php echo set_value('member_photo_height', element('member_photo_height', element('data', $view)) + 0); ?>" />px
                        (jpg, gif, png 만 가능)
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        가로길이 <input type="number" class="form-control" name="member_icon_width" id="member_icon_width" value="<?php echo set_value('member_icon_width', element('member_icon_width', element('data', $view)) + 0); ?>" />px,
                        세로길이 <input type="number" class="form-control" name="member_icon_height" id="member_icon_height" value="<?php echo set_value('member_icon_height', element('member_icon_height', element('data', $view)) + 0); ?>" />px
                        (jpg, gif, png 만 가능)
                    </div>
                </div>
                <div class="form-group">
