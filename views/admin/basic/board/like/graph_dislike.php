    ...
    <div class="box-table">
        <div class="box-table-header">
            <ul class="nav nav-pills">
                ...
                <li role="presentation" class="active"><a href="<?php echo admin_url($this->pagedir . '/graph_dislike'); ?>">비추 그래프 </a></li>
            </ul>
        ...
        <div class="table-responsive">
            <div class="pull-right form-group">
                <label for="withoutzero" class="checkbox-inline">
                    <input type="checkbox" name="withoutzero" id="withoutzero" value="1" /> 비추천수가 0 인 데이터 제외
                </label>
