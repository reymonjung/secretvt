        ...
        ?>
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="number" class="form-control" name="post_min_length" value="<?php echo set_value('post_min_length', element('post_min_length', element('data', $view)) + 0); ?>" />글자 이상 작성하셔야 합니다. 0 입력시 제한 없음, 에디터 사용시 적용 안됨
                    </div>
                    <div class="col-sm-2">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="number" class="form-control" name="post_max_length" value="<?php echo set_value('post_max_length', element('post_max_length', element('data', $view)) + 0); ?>" />글자 이하 작성하셔야 합니다. 0 입력시 제한 없음, 에디터 사용시 적용 안됨
                    </div>
                    <div class="col-sm-2">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        PC - <input type="number" class="form-control" name="link_num" value="<?php echo set_value('link_num', element('link_num', element('data', $view)) + 0); ?>" />개,
                        모바일 - <input type="number" class="form-control" name="mobile_link_num" value="<?php echo set_value('mobile_link_num', element('mobile_link_num', element('data', $view)) + 0); ?>" />개
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        PC - <input type="number" class="form-control" name="upload_file_num" value="<?php echo set_value('upload_file_num', element('upload_file_num', element('data', $view)) + 0); ?>" />개,
                        모바일 - <input type="number" class="form-control" name="mobile_upload_file_num" value="<?php echo set_value('mobile_upload_file_num', element('mobile_upload_file_num', element('data', $view)) + 0); ?>" />개
                        이하로 첨부가능
                    </div>
                    <div class="col-sm-2">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="number" class="form-control" name="upload_file_max_size" value="<?php echo set_value('upload_file_max_size', element('upload_file_max_size', element('data', $view)) + 0); ?>" /> MB /
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        가입한지 <input type="number" class="form-control" name="write_possible_days" value="<?php echo set_value('write_possible_days', element('write_possible_days', element('data', $view)) + 0); ?>" />일 이상 지난 회원만 글쓰기가 가능합니다.
