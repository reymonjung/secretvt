...
<section class="title">
		...
		<h2>
			시크릿 안전비자
			<span>
				관광단수 및 복수 , DN 비즈니스 거주증 및 문제비자 문의
			</span>
		</h2>
		<figure style="position: relative;">
				<img src="assets/images/temp/bottom_bn02.png">
				<figcaption style="position: absolute; width:188px; height: 40px; top: 0; bottom: 0; margin:auto; right: 3%; color: #fff;">
					<p style="margin-bottom:2%; text-align: right; font-size: 10px; line-height: 12px; ">
...
<section class="inquire">
	<ul>
		<li>
			<h3 onclick="return faq_open(this);">제목영역입니다.</h3>
			<div class="question">
				<p>
					질문내용 영역 입니다 .질문내용 영역 입니다질문내용 영역 입니다질문내용 영역 입니다질문내용 영역 입니다문내용 영역 입니질문내용 영역 입니다 .
				</p>
		...
		<li >
			...
			<div class="question">
				...
				<ul>
					<li>
						<p>
							댓글 영역 입니다.댓글 영역 입니다댓글 영역댓글 영역 입니다.댓글 영역 입니다댓글 영역댓글 영역 입니다.댓글 영역
						</p>
					</li>

					<li>
						<p>
							댓글 영역 입니다.댓글 영역 입니다댓글 영역댓글 영역 입니다.댓글 영역 입니다댓글 
						</p>
					</li>

					<li>
						<p>
							댓글 영역 입니다.댓글 영역 입니다댓글 영역댓글 영역 입니다.댓글 영역 입니다댓글 영역댓글 영역 입니다.댓글 영역입니다댓글 영역댓글 영역 입니다.댓글 영역
						</p>
					</li>
				</ul>
			</div>
