...
<div class="modal-body">
    <ul class="note_menu">
        <li><a href="<?php echo site_url('note/lists/recv'); ?>" class="btn btn-default <?php echo element('type', $view) === 'recv' ? 'active' : ''; ?>">받은 쪽지</a></li>
        <li><a href="<?php echo site_url('note/lists/send'); ?>" class="btn btn-default <?php echo element('type', $view) === 'send' ? 'active' : ''; ?>">보낸 쪽지</a></li>
    ...
    <div class="note-view mt3per">
        ...
        <div class="note-contents"><?php echo element('content', element('data', $view)); ?></div>
    </div>
